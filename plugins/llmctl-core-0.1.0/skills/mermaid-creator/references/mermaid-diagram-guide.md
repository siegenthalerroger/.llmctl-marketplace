...
This reference provides comprehensive guidance on creating effective Mermaid diagrams for design documents. For the diagram type selection matrix, see the main [SKILL.md](../SKILL.md).

---

## 1. C4 Context Diagrams

> [Official docs](https://mermaid.ai/open-source/syntax/c4.html)
...
> [Official docs](https://mermaid.ai/open-source/syntax/sequenceDiagram.html)
...
> [Official docs](https://mermaid.ai/open-source/syntax/classDiagram.html)
...
> [Official docs](https://mermaid.ai/open-source/syntax/entityRelationshipDiagram.html)
...
> [Official docs](https://mermaid.ai/open-source/syntax/stateDiagram.html)
...
> [Official docs](https://mermaid.ai/open-source/syntax/flowchart.html)
...
> [Official docs](https://mermaid.ai/open-source/syntax/gantt.html)
...
> [Official docs](https://mermaid.ai/open-source/syntax/userJourney.html)
...
> [Official docs](https://mermaid.ai/open-source/syntax/mindmap.html)

**Purpose:** Organize hierarchical concepts and brainstorming output
...
- Use concise labels (1-3 words per node)
...
> [Official docs](https://mermaid.ai/open-source/syntax/architecture.html)

**Purpose:** Visualize infrastructure components and their connections

**When to use:**
- Cloud infrastructure documentation
- Deployment topology
- Service mesh / network layout
...
> [!NOTE]
> Architecture diagrams use the `architecture-beta` keyword. Syntax may evolve — consult the official Mermaid docs for the latest specification.

**Best Practices:**
- Use `group` to represent logical boundaries (VPC, region, cluster)
- Keep to 8-12 services per diagram
- Use Unicode symbols in labels for visual clarity (e.g., `☁️ Cloud`, `💾 DB`)
...
- [Mermaid Official Docs](https://mermaid.ai/open-source/syntax/flowchart.html) — full syntax reference for all diagram types
